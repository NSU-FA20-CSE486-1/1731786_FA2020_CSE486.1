...
public class MainActivity extends AppCompatActivity {
    ...
    // method for when SecondActivity returns intent after the finish method
    //it's called when the activity you have launched exits.
    @Override
    ...
    public void searchStores(View view) {
        ...
        Uri foodLocation = Uri.parse("geo:0,0?q=" + location);
        Intent intent = new Intent(Intent.ACTION_VIEW, foodLocation);
