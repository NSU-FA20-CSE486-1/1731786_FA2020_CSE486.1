package me.salmalabclass.shoppinglist;
    ...
    public void selectItem(View view) {
        ...
        switch (view.getId()){
            case R.id.button_Chocolate:
                return_items_intent.putExtra(EXTRA_ITEMS, "Pudding"); setResult(RESULT_OK, return_items_intent); finish();
                break;
            case R.id.button_oil:
                return_items_intent.putExtra(EXTRA_ITEMS, "Vegetables"); setResult(RESULT_OK, return_items_intent); finish();
                break;
            ...
            case R.id.button_wheat:
                return_items_intent.putExtra(EXTRA_ITEMS, "Flour"); setResult(RESULT_OK, return_items_intent); finish();
                break;
            ...
            case R.id.button_sugar:
                return_items_intent.putExtra(EXTRA_ITEMS, "Brown Sugar"); setResult(RESULT_OK, return_items_intent); finish();
                break;
            case R.id.button_salt:
                return_items_intent.putExtra(EXTRA_ITEMS, "Fruits"); setResult(RESULT_OK, return_items_intent); finish();
                break;
            default:
